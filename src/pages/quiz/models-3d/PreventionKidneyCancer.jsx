...
const PreventionKidneyCancer = (props) => {
  const { nodes, materials } = useGLTF('/models-3d/prevention-kidney-cancer.glb');
    ...
    <group {...props} dispose={null}>
      ...
      >
        <mesh
          castShadow
          receiveShadow
          geometry={nodes.Cylinder003_baking_0.geometry}
          material={materials.baking}
        />
        {showInfo && (
...
useGLTF.preload('/models-3d/preventions-kidney-cancer.glb');

export default PreventionKidneyCancer;
